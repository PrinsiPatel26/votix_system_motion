...
export function TopEntrySeriesDetail() {
  ...
  const overviewTabs = useMemo(() => ({
    ...
    'Technical Details': (
      <div className="overflow-hidden rounded-xl border border-steel-200 bg-white">
        <div className="grid grid-cols-1">
          {series.specificationTable.map((item) => (
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border border-steel-200 bg-white p-5">
          ...
          <ul className="mt-4 space-y-2 text-sm leading-relaxed text-steel-600">
            <li>• Top-entry mounting arrangement matched to tank geometry</li>
            ...
            <li>• Motor and gearbox sized for duty and service requirements</li>
          </ul>
        </div>
        <div className="rounded-xl border border-steel-200 bg-white p-5">
          <h3 className="font-display text-xl font-extrabold text-navy">Recommended Selection Criteria</h3>
          <ul className="mt-4 space-y-2 text-sm leading-relaxed text-steel-600">
            <li>• Viscosity and process sensitivity</li>
            <li>• Tank turn-over requirement</li>
            <li>• Mixing objective: blending, suspension or dispersion</li>
            <li>• Thermal and sanitary operating conditions</li>
          </ul>
        </div>
      </div>
    ),
            ...
            <div className="mt-5 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
              {series.compatibleImpellers.map((impeller) => (
                <Link
                  ...
                  className="group overflow-hidden rounded-xl border border-steel-200 bg-white shadow-card transition-all duration-200 ease-smooth hover:border-brand-200 hover:shadow-lift">
